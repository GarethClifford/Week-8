...
public class Testing {
	...
	public void browserTest() throws InterruptedException {
		...
		driver.get(url);
		WebElement signup = driver.findElement(By.xpath("/html/body/div/center/table/tbody/tr[2]/td/div/center/table/tbody/tr/td[2]/p/small/a[3]"));
		signup.click();
		...
		submit.click();
		WebElement signin = driver.findElement(By.xpath("/html/body/div/center/table/tbody/tr[2]/td/div/center/table/tbody/tr/td[2]/p/small/a[4]"));
		signin.click();
		...
		WebElement btn = driver.findElement(By.xpath("/html/body/table/tbody/tr/td[1]/form/div/center/table/tbody/tr/td[1]/table/tbody/tr[3]/td[2]/p/input"));
		uname.sendKeys("gclifford");
